    ...
    switch (taxPercentage) {
        case 5:
            return [
                ...
                { name: 'Post office monthly income scheme', percentage: '5-10%', priority: 2 },
                { name: 'Recurring Deposits', percentage: '10-20%', priority: 3 },
                { name: 'Life Insurance Premiums', percentage: '10-20%', priority: 4 },
                { name: 'Gold investment(yearly)', percentage: '10-20%', priority: 5 },
            ];
        case 10:
            return [
                { name: 'Post office monthly scheme', percentage: '10-20%', priority: 1 },
                { name: 'Fixed Deposits', percentage: '5-10%', priority: 2 },
                { name: 'Leave Travel Allowance', percentage: '10-20%', priority: 3 },
                { name: 'Eduguard Plan', percentage: '10-20%', priority: 4 },
                { name: 'Mutual Funds', percentage: '10-20%', priority: 5 },
            ];
        case 15:
            return [
                { name: 'Post office monthly scheme', percentage: '10-20%', priority: 1 },
